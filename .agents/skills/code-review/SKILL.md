---
name: code-review
description: Code review guidelines for the wiki project, ensuring consistency, catching anti-patterns, and enforcing established conventions. Use this skill when reviewing code for architectural decisions, pattern mismatches, and violations of explicit project guidelines. Focus on actionable feedback that clearly states what is wrong and what the correct approach is.
---
